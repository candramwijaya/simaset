...
<head>
  ...
  <title><?=$title;?> | SIM Aset</title>
  <!-- jquery date tipe picker -->
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview <?=isset($active_menu_master)?$active_menu_master:'' ?>">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?=base_url('satuan')?>" class="nav-link <?=isset($active_menu_st)?$active_menu_st:'' ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Satuan</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          <a href="<?=base_url('peminjaman')?>" class="nav-link <?=isset($active_menu_peminjaman)?$active_menu_peminjaman:'' ?>">
            <i class="nav-icon fa fa-users"></i>
            <p>Peminjaman</p>
          </a>
        </li>
        <li class="nav-item has-treeview">
          <a href="<?=base_url('mutasi')?>" class="nav-link <?=isset($active_menu_mutasi)? $active_menu_mutasi:'' ?>">
        ...
        <li class="nav-item has-treeview <?=isset($active_menu_lp)?$active_menu_lp:'' ?>">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?=base_url('laporan/mutasi-aset')?>" class="nav-link <?=isset($active_menu_lm)?$active_menu_lm:'' ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Mutasi Aset</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?=base_url('laporan/peminjaman-aset')?>" class="nav-link <?=isset($active_menu_lpj)?$active_menu_lpj:'' ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Peminjaman</p>
              </a>
            </li>
