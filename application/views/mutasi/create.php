  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" action="<?=base_url('mutasi/simpan')?>" autocomplete="off" method="post">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                   <input type="text" name="nama_user_m" id="nama_user_m" class="form-control" readonly>     
                </div>
              </div>
              <div class="form-group row">
                <label for="asal_lokasi" class="col-sm-2 col-form-label">Lokasi</label>
                <div class="col-sm-6">
                  <input type="text" name="lokasi_m" id="lokasi_m" class="form-control" readonly>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" id="datepicker" name="tgl_mutasi" class="form-control" placeholder="Masukan Tanggal Mutasi" required>	
                </div>
              </div>
              <div class="form-group row">
