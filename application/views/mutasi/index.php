  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">
          <a href="<?=base_url('mutasi/tambah')?>" class="btn btn-block bg-gradient-primary">
            Tambah Data
          </a>
        </h3>
              ...
              <table id="example1" class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$row['status'];?></td>
                    <td>
                       <a href="<?=base_url('mutasi/edit/'.$row['id'])?>" class="btn btn-info btn-sm">
                          <i class="fas fa-edit"></i>
                        </a>
                        <a href="<?=base_url('mutasi/hapus/'.$row['id'])?>" class="btn btn-danger btn-sm tombol-hapus">
