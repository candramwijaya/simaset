      ...
      <div class="card-header">
        <h3 class="card-title">
          ...
          <div class="card-body">
              ...
              <a href="<?=base_url('laporan/print_penghapusan/').$this->input->post('id_lokasi').'/'.$this->input->post('tahun_perolehan')?>" target="_blank" class="btn btn-danger mt-4">
                <i class="fa fa-print" aria-hidden="true"></i> Print
              </a>
              <a href="<?=base_url('laporan/export_penghapusan/').$this->input->post('id_lokasi').'/'.$this->input->post('tahun_perolehan')?>" class="btn btn-success mt-4">
