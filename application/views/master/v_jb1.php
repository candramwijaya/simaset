    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <div class="card-body">
          <form action="<?=base_url('kategori/filter')?>" method="POST">
              <div class="row">
                  <div class="col-3">
                    <input type="text" id="keyword" class="form-control" placeholder="Masukkan Kata Kunci" name="kata_kunci">
                  ...
                  <div class="col-2">
                    <a href="<?=base_url('kategori')?>" type="reset" class="btn btn-block btn-outline-danger">Reset</a>
                  </div>              
              </div>
          </form> 
          <br/>
