              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <select name="jenis_bantuan" class="form-control" required>
                    <option value="">- Pilih --</option>
                    <option <?php if($row['jenis_bantuan'] == 'Sekolah'){ echo 'selected="selected"'; } ?> value="Sekolah">Sekolah</option>
                    <option <?php if($row['jenis_bantuan'] == 'Yayasan'){ echo 'selected="selected"'; } ?> value="Yayasan">Yayasan</option>
                    <option <?php if($row['jenis_bantuan'] == 'Pemerintah'){ echo 'selected="selected"'; } ?> value="Pemerintah">Pemerintah</option>     
                  </select>
                </div>
              </div>
              <div class="form-group row">
